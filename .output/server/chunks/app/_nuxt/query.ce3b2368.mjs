...
import { u as useRequestEvent, w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils.7212c7a3.mjs';
...
const createQueryFetch = (path) => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db.c86ad533.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query.ce3b2368.mjs.map
