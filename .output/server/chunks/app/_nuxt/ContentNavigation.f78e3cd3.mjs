...
import { u as useAsyncData, j as jsonStringify, a as useCookie } from './query.f9ce131a.mjs';
import { hash } from 'ohash';
import { b as useContentDisabled, w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils.e0a74da4.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db.751aabb0.mjs').then((m) => m.generateNavigation);
...
defineAsyncComponent(() => import(
  ...
  './Counter.3f7f529a.mjs'
).then((c) => c.default || c));
defineAsyncComponent(() => import(
  /* webpackChunkName: "components/email-button" */
  './EmailButton.193ba0af.mjs'
).then((c) => c.default || c));
defineAsyncComponent(() => import(
...
//# sourceMappingURL=ContentNavigation.f78e3cd3.mjs.map
