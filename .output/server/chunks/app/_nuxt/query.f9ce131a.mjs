...
import { u as useRequestEvent, w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils.e0a74da4.mjs';
...
const createQueryFetch = (path) => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db.751aabb0.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query.f9ce131a.mjs.map
