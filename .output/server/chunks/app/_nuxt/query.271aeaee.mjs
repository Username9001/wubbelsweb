...
import { u as useRequestEvent, w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils.7e955439.mjs';
...
const createQueryFetch = (path) => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db.0808f31b.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query.271aeaee.mjs.map
