...
import { u as useAsyncData, j as jsonStringify, a as useCookie } from './query.ce3b2368.mjs';
import { hash } from 'ohash';
import { b as useContentDisabled, w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils.7212c7a3.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db.c86ad533.mjs').then((m) => m.generateNavigation);
...
defineAsyncComponent(() => import(
  ...
  './Counter.6433acbe.mjs'
).then((c) => c.default || c));
defineAsyncComponent(() => import(
  /* webpackChunkName: "components/email-button" */
  './EmailButton.4e21d8dd.mjs'
).then((c) => c.default || c));
defineAsyncComponent(() => import(
...
//# sourceMappingURL=ContentNavigation.cdf6d579.mjs.map
