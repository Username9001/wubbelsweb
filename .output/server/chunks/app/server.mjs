...
const appHead = { "meta": [{ "name": "viewport", "content": "width=device-width, initial-scale=1" }, { "charset": "utf-8" }], "link": [{ "rel": "icon", "type": "image/x-icon", "href": "/favicon.ico" }, { "href": "https://pftest.wubbbelsweb.com/fonts/Montserrat.ttf", "as": "font", "type": "font/ttf" }, { "href": "https://pftest.wubbbelsweb.com/fonts/Karrik-Regular.woff2", "as": "font", "type": "font/woff2" }, { "rel": "manifest", "href": "/manifest.json" }], "style": [], "script": [], "noscript": [], "title": "WubbbelsWeb", "description": "Base description", "htmlAttrs": { "lang": "en" } };
...
const _routes = [
  {
    ...
    component: () => import('./_nuxt/about.0619be5c.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/contact.55fd07e9.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/index.df4e0435.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/_slug_.460df019.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component.e8f5b5fe.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
const layouts = {
  default: () => import('./_nuxt/default.1424cbaf.mjs').then((m) => m.default || m)
};
