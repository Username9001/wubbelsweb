...
import { u as useAsyncData, j as jsonStringify, a as useCookie } from './query.aea59c23.mjs';
import { hash } from 'ohash';
import { b as useContentDisabled, w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils.a66359ab.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db.dd28dc23.mjs').then((m) => m.generateNavigation);
...
defineAsyncComponent(() => import(
  ...
  './Counter.b2ca076d.mjs'
).then((c) => c.default || c));
defineAsyncComponent(() => import(
  /* webpackChunkName: "components/email-button" */
  './EmailButton.7e4ff157.mjs'
).then((c) => c.default || c));
defineAsyncComponent(() => import(
...
//# sourceMappingURL=ContentNavigation.1626d34c.mjs.map
