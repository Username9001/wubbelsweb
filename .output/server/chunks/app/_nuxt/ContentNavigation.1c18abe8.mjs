import { d as useNuxtApp, u as useState, b as useHead, _ as __nuxt_component_0$1 } from '../server.mjs';
...
import { u as useAsyncData, j as jsonStringify, a as useCookie } from './query.c22fbb98.mjs';
import { hash } from 'ohash';
import { b as useContentDisabled, w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils.76ba10c8.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db.af85b16c.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation.1c18abe8.mjs.map
