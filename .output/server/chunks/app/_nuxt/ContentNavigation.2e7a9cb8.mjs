...
import { u as useAsyncData, j as jsonStringify, a as useCookie } from './query.271aeaee.mjs';
import { hash } from 'ohash';
import { b as useContentDisabled, w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils.7e955439.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db.0808f31b.mjs').then((m) => m.generateNavigation);
...
defineAsyncComponent(() => import(
  ...
  './Counter.c0f3cf8b.mjs'
).then((c) => c.default || c));
defineAsyncComponent(() => import(
  /* webpackChunkName: "components/email-button" */
  './EmailButton.24dfc532.mjs'
).then((c) => c.default || c));
defineAsyncComponent(() => import(
...
//# sourceMappingURL=ContentNavigation.2e7a9cb8.mjs.map
