...
import { u as useRequestEvent, w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils.76ba10c8.mjs';
...
const createQueryFetch = (path) => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db.af85b16c.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query.c22fbb98.mjs.map
