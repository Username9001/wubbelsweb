...
const components = {};
function componentsPlugin_36cdd0de(nuxtApp) {
...
const vueuseHead_8efc6ab2 = defineNuxtPlugin((nuxtApp) => {
...
const _0457b09b = defineNuxtPlugin((nuxtApp) => {
...
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<li${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "project-item" }, _attrs))}><div class="project-header"><h2 class="project-title">${serverRenderer.exports.ssrInterpolate($props.project.title)}</h2></div><p>${serverRenderer.exports.ssrInterpolate($props.project.description)}</p><div class="used-tech"><small>Technologies used: </small><!--[-->`);
  serverRenderer.exports.ssrRenderList($props.project.stack, (item) => {
    _push(`<small><i>${serverRenderer.exports.ssrInterpolate(item)}</i></small>`);
  });
  _push(`<!--]--></div><br>`);
  if ($props.project.link) {
    ...
    _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, {
      ...
      default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(` Visit ${serverRenderer.exports.ssrInterpolate($props.project.title)}`);
        } else {
          return [
            vue_cjs_prod.createTextVNode(" Visit " + vue_cjs_prod.toDisplayString($props.project.title), 1)
          ];
        }
      }),
      _: 1
...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "technologies" }, _attrs))}><!--[-->`);
  serverRenderer.exports.ssrRenderList($props.technologies, (stack) => {
    _push(`<div class="tech"><h3 class="tech-title">${serverRenderer.exports.ssrInterpolate(stack.title)}</h3><div class="tech-list"><!--[-->`);
    serverRenderer.exports.ssrRenderList(stack.list, (tech) => {
      _push(`<div class="tech-item">${serverRenderer.exports.ssrInterpolate(tech)}</div>`);
    });
    _push(`<!--]--></div></div>`);
  });
  _push(`<!--]--></div>`);
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_nuxt_link = __nuxt_component_0$2;
  _push(`<!--[--><svg id="footer-wave" viewBox="0 0 2200 120" width="2200" height="120" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" data-v-3c50a86a><path d="M0 47L52.3 50C104.7 53 209.3 59 314.2 61C419 63 524 61 628.8 58.2C733.7 55.3 838.3 51.7 943 51C1047.7 50.3 1152.3 52.7 1257 58.5C1361.7 64.3 1466.3 73.7 1571.2 75.7C1676 77.7 1781 72.3 1885.8 72.8C1990.7 73.3 2095.3 79.7 2147.7 82.8L2200 86L2200 121L2147.7 121C2095.3 121 1990.7 121 1885.8 121C1781 121 1676 121 1571.2 121C1466.3 121 1361.7 121 1257 121C1152.3 121 1047.7 121 943 121C838.3 121 733.7 121 628.8 121C524 121 419 121 314.2 121C209.3 121 104.7 121 52.3 121L0 121Z" stroke-linecap="round" stroke-linejoin="miter" data-v-3c50a86a></path></svg><footer id="footer" data-v-3c50a86a><div class="contact-info" data-v-3c50a86a><div class="contact-text-block" data-v-3c50a86a> Feel free to contact me through one of the following links <br data-v-3c50a86a> \u2193 </div><ul class="socials" data-v-3c50a86a><li class="w-to-b-gradient" data-v-3c50a86a>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, { to: "mailto:erik.wubbels@gmail.com" }, {
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${serverRenderer.exports.ssrRenderAttr("src", _imports_0)} alt="" data-v-3c50a86a${_scopeId}>`);
      } else {
        return [
  ...
  _push(`</li><li class="w-to-b-gradient" data-v-3c50a86a>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, {
    to: "https://linkedin.com/in/erik-wubbels-353176117/",
    target: "#"
  }, {
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${serverRenderer.exports.ssrRenderAttr("src", _imports_1)} alt="" data-v-3c50a86a${_scopeId}>`);
      } else {
        return [
          vue_cjs_prod.createVNode("img", {
            src: _imports_1,
  ...
  _push(`</li><li class="w-to-b-gradient" data-v-3c50a86a>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, {
    to: "https://instagram.com/erikwubbels",
    target: "#"
  }, {
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${serverRenderer.exports.ssrRenderAttr("src", _imports_2)} alt="" data-v-3c50a86a${_scopeId}>`);
      } else {
        return [
          vue_cjs_prod.createVNode("img", {
            src: _imports_2,
  ...
  _push(`</li><li class="w-to-b-gradient" data-v-3c50a86a>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, {
    to: "https://github.com/Username9001",
    target: "#"
  }, {
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${serverRenderer.exports.ssrRenderAttr("src", _imports_3)} alt="" data-v-3c50a86a${_scopeId}>`);
      } else {
        return [
          vue_cjs_prod.createVNode("img", {
            src: _imports_3,
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-3c50a86a"]]);
const meta = void 0;
const routes = [
  {
    name: "index",
  ...
  },
  {
    name: "portfolio",
    path: "/portfolio",
    file: "/home/erik/webdev/wubbelsweb/pages/portfolio.vue",
    children: [],
    meta,
    alias: [],
    component: () => Promise.resolve().then(function() {
...
const _4d07a409 = defineNuxtPlugin(async (nuxtApp) => {
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, vue_cjs_prod.mergeProps({
    ...
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<p class="rule"${_scopeId}>WubbelsWeb</p>`);
      } else {
        return [
          vue_cjs_prod.createVNode("p", { class: "rule" }, "WubbelsWeb")
        ];
      }
    }),
    _: 1
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_Project = __nuxt_component_0$1;
  const _component_Technologies = __nuxt_component_1;
  const _component_Footer = __nuxt_component_2;
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ id: "portfolio" }, _attrs))}><div class="header"><h1>Portfolio / CV</h1><h3>${serverRenderer.exports.ssrInterpolate($data.personalia.name)}</h3><div class="about"><h2>About Erik</h2><p>${serverRenderer.exports.ssrInterpolate($data.personalia.description)}</p></div><a href="#main" class="first-link"><button><div> To Portfolio \u2193 </div></button></a></div><div id="header-wave"><svg viewBox="0 0 2200 120" width="2200" height="120" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"><path d="M0 68L21.5 69.2C43 70.3 86 72.7 129.2 74.2C172.3 75.7 215.7 76.3 258.8 73.5C302 70.7 345 64.3 388.2 62.8C431.3 61.3 474.7 64.7 517.8 61.2C561 57.7 604 47.3 647 48.2C690 49 733 61 776.2 65.2C819.3 69.3 862.7 65.7 905.8 63.7C949 61.7 992 61.3 1035.2 62.3C1078.3 63.3 1121.7 65.7 1164.8 67.7C1208 69.7 1251 71.3 1294.2 72.8C1337.3 74.3 1380.7 75.7 1423.8 77.5C1467 79.3 1510 81.7 1553 74.3C1596 67 1639 50 1682.2 46.2C1725.3 42.3 1768.7 51.7 1811.8 56C1855 60.3 1898 59.7 1941.2 56.5C1984.3 53.3 2027.7 47.7 2070.8 51.2C2114 54.7 2157 67.3 2178.5 73.7L2200 80L2200 0L2178.5 0C2157 0 2114 0 2070.8 0C2027.7 0 1984.3 0 1941.2 0C1898 0 1855 0 1811.8 0C1768.7 0 1725.3 0 1682.2 0C1639 0 1596 0 1553 0C1510 0 1467 0 1423.8 0C1380.7 0 1337.3 0 1294.2 0C1251 0 1208 0 1164.8 0C1121.7 0 1078.3 0 1035.2 0C992 0 949 0 905.8 0C862.7 0 819.3 0 776.2 0C733 0 690 0 647 0C604 0 561 0 517.8 0C474.7 0 431.3 0 388.2 0C345 0 302 0 258.8 0C215.7 0 172.3 0 129.2 0C86 0 43 0 21.5 0L0 0Z" stroke-linecap="round" stroke-linejoin="miter"></path></svg></div><div id="main" class="main"><h3 class="grid-title"> Live websites <hr></h3><ul class="project-grid"><!--[-->`);
  serverRenderer.exports.ssrRenderList($data.live_projects, (project) => {
    _push(serverRenderer.exports.ssrRenderComponent(_component_Project, {
      key: project.title,
      project
    }, null, _parent));
  });
  _push(`<!--]--></ul><h3 class="grid-title"> Personal Projects <hr></h3><ul class="project-grid"><!--[-->`);
  serverRenderer.exports.ssrRenderList($data.personal_projects, (project) => {
    _push(serverRenderer.exports.ssrRenderComponent(_component_Project, {
      key: project.title,
      project
    }, null, _parent));
  });
  _push(`<!--]--></ul><h3 class="grid-title"> Past Projects <small>(no longer available)</small><hr></h3><ul class="project-grid"><!--[-->`);
  serverRenderer.exports.ssrRenderList($data.old_projects, (project) => {
    _push(serverRenderer.exports.ssrRenderComponent(_component_Project, {
      key: project.title,
      project
    }, null, _parent));
  });
  _push(`<!--]--></ul><br><h3 class="grid-title"> Accustomed with the following technologies: <hr></h3>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_Technologies, { technologies: $data.technologies }, null, _parent));
  _push(`</div>`);
